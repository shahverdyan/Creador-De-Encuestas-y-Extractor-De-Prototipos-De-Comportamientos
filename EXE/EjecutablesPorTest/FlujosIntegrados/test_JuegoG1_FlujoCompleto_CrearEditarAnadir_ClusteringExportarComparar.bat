@echo off
REM Test: Juego G1 (Flujo completo: Crear, Editar, Anadir, Clustering, Exportar, Comparar)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\FlujosIntegrados\JuegoG1_FlujoCompleto_CrearEditarAnadir_ClusteringExportarComparar.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\FlujosIntegrados\output_esperado_G1.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego G1 (Flujo Completo)
