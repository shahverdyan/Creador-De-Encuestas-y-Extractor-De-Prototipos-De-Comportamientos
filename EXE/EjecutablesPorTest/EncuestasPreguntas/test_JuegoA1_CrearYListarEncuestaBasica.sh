...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/EncuestasPreguntas/JuegoA1_CrearYListarEncuestaBasica.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/EncuestasPreguntas/output_esperado_A1.txt"
