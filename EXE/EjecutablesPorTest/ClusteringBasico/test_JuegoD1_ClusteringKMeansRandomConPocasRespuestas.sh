...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/ClusteringBasico/JuegoD1_ClusteringKMeansRandomConPocasRespuestas.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/ClusteringBasico/output_esperado_D1.txt"
