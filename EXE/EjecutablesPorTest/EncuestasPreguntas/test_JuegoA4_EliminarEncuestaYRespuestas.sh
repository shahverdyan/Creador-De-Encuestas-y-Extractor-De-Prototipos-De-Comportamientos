...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/EncuestasPreguntas/JuegoA4_EliminarEncuestaYRespuestas.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/EncuestasPreguntas/output_esperado_A4.txt"
