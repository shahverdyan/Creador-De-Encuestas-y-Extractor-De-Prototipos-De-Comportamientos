@echo off
REM Test: Juego E2 (Calcular accuracy loan-train)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\ClusteringAvanzado\JuegoE2_CalcularAccuracyLoanTrain.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\ClusteringAvanzado\output_esperado_E2.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego E2 (Calcular accuracy loan-train)
