...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/Respuestas/JuegoB1_AgregarVariasRespuestasDistintosParticipantes.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/Respuestas/output_esperado_B1.txt"
...
echo "-----------------------------------------------------"
echo "Ejecutando Test: Juego B1 (Agregar varias respuestas de distintos participantes)"
