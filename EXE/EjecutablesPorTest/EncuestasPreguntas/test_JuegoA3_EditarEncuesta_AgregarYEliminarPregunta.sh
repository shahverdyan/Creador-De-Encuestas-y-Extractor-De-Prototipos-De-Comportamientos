...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/EncuestasPreguntas/JuegoA3_EditarEncuesta_AgregarYEliminarPregunta.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/EncuestasPreguntas/output_esperado_A3.txt"
...
echo "-----------------------------------------------------"
echo "Ejecutando Test: Juego A3 (Editar encuesta y agregar y eliminar pregunta)"
