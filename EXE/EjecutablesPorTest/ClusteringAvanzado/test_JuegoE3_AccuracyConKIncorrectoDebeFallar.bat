@echo off
REM Test: Juego E3 (Accuracy con K incorrecto debe fallar)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\ClusteringAvanzado\JuegoE3_AccuracyConKIncorrectoDebeFallar.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\ClusteringAvanzado\output_esperado_E3.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego E3 (Accuracy con K incorrecto debe fallar)
