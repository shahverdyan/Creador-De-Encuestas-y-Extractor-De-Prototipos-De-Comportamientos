@echo off
REM Test: Juego C2 (Exportar encuesta sin respuestas)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\ImportarExportar\JuegoC2_ExportarEncuestaSinRespuestas.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\ImportarExportar\output_esperado_C2.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego C2 (Exportar encuesta sin respuestas)
