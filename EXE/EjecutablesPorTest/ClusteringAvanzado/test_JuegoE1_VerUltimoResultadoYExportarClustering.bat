@echo off
REM Test: Juego E1 (Ver ultimo resultado y exportar clustering)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\ClusteringAvanzado\JuegoE1_VerUltimoResultadoYExportarClustering.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\ClusteringAvanzado\output_esperado_E1.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego E1 (Ver ultimo resultado y exportar clustering)
