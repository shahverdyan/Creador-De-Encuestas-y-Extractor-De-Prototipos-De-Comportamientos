...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/ClusteringAvanzado/JuegoE1_VerUltimoResultadoYExportarClustering.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/ClusteringAvanzado/output_esperado_E1.txt"
