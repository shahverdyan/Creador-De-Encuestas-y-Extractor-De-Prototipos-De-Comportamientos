...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/ComparaciondeFicheros/JuegoF2_CompararFicherosConDiferencias.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/ComparaciondeFicheros/output_esperado_F2.txt"
