@echo off
REM Test: Juego D1 (Clustering KMeans Random con pocas respuestas)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\ClusteringBasico\JuegoD1_ClusteringKMeansRandomConPocasRespuestas.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\ClusteringBasico\output_esperado_D1.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego D1 (Clustering KMeans Random con pocas respuestas)
