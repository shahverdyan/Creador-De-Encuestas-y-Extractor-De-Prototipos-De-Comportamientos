...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/EncuestasPreguntas/JuegoA2_CrearConPreguntasDeTodosLosTipos.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/EncuestasPreguntas/output_esperado_A2.txt"
