...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/ClusteringAvanzado/JuegoE4_ClusteringKMeansYKMedoidsComparacion.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/ClusteringAvanzado/output_esperado_E4.txt"
...
echo "-----------------------------------------------------"
echo "Ejecutando Test: Juego E4 (Clusetering KMeans y KMedoids comparacion)"
