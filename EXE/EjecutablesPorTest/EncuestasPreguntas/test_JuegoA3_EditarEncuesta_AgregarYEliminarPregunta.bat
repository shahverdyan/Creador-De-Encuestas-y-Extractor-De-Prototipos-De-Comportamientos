@echo off
REM Test: Juego A3 (Editar encuesta: agregar y eliminar pregunta)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\EncuestasPreguntas\JuegoA3_EditarEncuesta_AgregarYEliminarPregunta.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\EncuestasPreguntas\output_esperado_A3.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego A3 (Editar encuesta)
