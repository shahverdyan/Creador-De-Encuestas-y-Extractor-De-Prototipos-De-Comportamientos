...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/ClusteringBasico/JuegoD4_SinRespuestasNoSePuedeVectorizar.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/ClusteringBasico/output_esperado_D4.txt"
