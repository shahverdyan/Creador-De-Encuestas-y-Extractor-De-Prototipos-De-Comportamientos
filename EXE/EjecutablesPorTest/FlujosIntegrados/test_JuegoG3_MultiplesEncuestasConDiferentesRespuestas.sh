...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/FlujosIntegrados/JuegoG3_MultiplesEncuestasConDiferentesRespuestas.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/FlujosIntegrados/output_esperado_G3.txt"
...
echo "-----------------------------------------------------"
echo "Ejecutando Test: Juego G3 (Multiples encuestas con diferentes respuestas)"
