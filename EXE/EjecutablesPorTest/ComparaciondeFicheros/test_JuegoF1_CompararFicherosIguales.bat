@echo off
REM Test: Juego F1 (Comparar ficheros iguales)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\ComparaciondeFicheros\JuegoF1_CompararFicherosIguales.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\ComparaciondeFicheros\output_esperado_F1.txt"
