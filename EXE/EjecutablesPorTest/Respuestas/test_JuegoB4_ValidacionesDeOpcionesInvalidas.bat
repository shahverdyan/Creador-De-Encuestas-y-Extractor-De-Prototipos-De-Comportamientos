@echo off
REM Test: Juego B4 (Validaciones de opciones invalidas)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\Respuestas\JuegoB4_ValidacionesDeOpcionesInvalidas.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\Respuestas\output_esperado_B4.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego B4 (Validaciones de opciones invalidas)
