@echo off
REM Test: Juego A1 (Crear y listar encuesta basica)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\EncuestasPreguntas\JuegoA1_CrearYListarEncuestaBasica.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\EncuestasPreguntas\output_esperado_A1.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego A1 (Crear y listar encuesta basica)
