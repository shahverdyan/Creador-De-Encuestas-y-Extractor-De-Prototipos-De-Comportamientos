@echo off
REM Test: Juego F2 (Comparar ficheros con diferencias)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\ComparaciondeFicheros\JuegoF2_CompararFicherosConDiferencias.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\ComparaciondeFicheros\output_esperado_F2.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego F2 (Comparar ficheros con diferencias)
