@echo off
REM Test: Juego B2 (Eliminar respuesta de participante)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\Respuestas\JuegoB2_EliminarRespuestaDeParticipante.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\Respuestas\output_esperado_B2.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego B2 (Eliminar respuesta de participante)
