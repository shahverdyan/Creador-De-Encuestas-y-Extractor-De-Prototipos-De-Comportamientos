@echo off
REM Test: Juego D3 (Clustering KMedoids PAM)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\ClusteringBasico\JuegoD3_ClusteringKMedoidsPAM.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\ClusteringBasico\output_esperado_D3.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego D3 (Clustering KMedoids PAM)
