@echo off
REM Test: Juego G3 (Multiples encuestas con diferentes respuestas)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\FlujosIntegrados\JuegoG3_MultiplesEncuestasConDiferentesRespuestas.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\FlujosIntegrados\output_esperado_G3.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego G3 (Multiples encuestas...)
