@echo off
REM Test: Juego A2 (Crear con preguntas de todos los tipos)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\EncuestasPreguntas\JuegoA2_CrearConPreguntasDeTodosLosTipos.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\EncuestasPreguntas\output_esperado_A2.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego A2 (Crear con preguntas de todos los tipos)
