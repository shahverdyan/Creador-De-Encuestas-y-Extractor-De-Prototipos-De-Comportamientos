...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/ImportarExportar/JuegoC1_ImportarYExportarMismaEncuesta.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/ImportarExportar/output_esperado_C1.txt"
