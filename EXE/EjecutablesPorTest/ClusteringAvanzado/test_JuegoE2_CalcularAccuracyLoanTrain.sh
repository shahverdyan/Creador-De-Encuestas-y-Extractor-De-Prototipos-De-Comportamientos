...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/ClusteringAvanzado/JuegoE2_CalcularAccuracyLoanTrain.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/ClusteringAvanzado/output_esperado_E2.txt"
...
echo "-----------------------------------------------------"
echo "Ejecutando Test: Juego E2 (calcular accuracy en LoanTarin)"
