@echo off
REM Test: Juego B3 (Eliminar todas las respuestas)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\Respuestas\JuegoB3_EliminarTodasLasRespuestas.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\Respuestas\output_esperado_B3.txt"
