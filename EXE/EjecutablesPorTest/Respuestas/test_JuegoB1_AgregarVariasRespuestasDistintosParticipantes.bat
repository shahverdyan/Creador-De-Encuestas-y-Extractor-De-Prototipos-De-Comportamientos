@echo off
REM Test: Juego B1 (Agregar varias respuestas de distintos participantes)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\Respuestas\JuegoB1_AgregarVariasRespuestasDistintosParticipantes.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\Respuestas\output_esperado_B1.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego B1 (Agregar varias respuestas)
