@echo off
REM Test: Juego C1 (Importar y exportar misma encuesta)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\ImportarExportar\JuegoC1_ImportarYExportarMismaEncuesta.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\ImportarExportar\output_esperado_C1.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego C1 (Importar y exportar misma encuesta)
