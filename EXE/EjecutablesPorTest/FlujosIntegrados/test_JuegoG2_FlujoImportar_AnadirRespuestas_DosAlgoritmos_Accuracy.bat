@echo off
REM Test: Juego G2 (Flujo importar, añadir respuestas, dos algoritmos, accuracy)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\FlujosIntegrados\JuegoG2_FlujoImportar_AnadirRespuestas_DosAlgoritmos_Accuracy.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\FlujosIntegrados\output_esperado_G2.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego G2 (Flujo Importar y Accuracy)
