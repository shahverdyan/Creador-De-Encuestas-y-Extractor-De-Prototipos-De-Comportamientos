@echo off
REM Test: Juego D4 (Sin respuestas no se puede vectorizar)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\ClusteringBasico\JuegoD4_SinRespuestasNoSePuedeVectorizar.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\ClusteringBasico\output_esperado_D4.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego D4 (Sin respuestas no se puede vectorizar)
