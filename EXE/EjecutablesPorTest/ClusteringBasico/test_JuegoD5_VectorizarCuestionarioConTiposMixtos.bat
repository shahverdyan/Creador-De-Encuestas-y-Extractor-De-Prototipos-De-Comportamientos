@echo off
REM Test: Juego D5 (Vectorizar cuestionario con tipos mixtos)
pushd "%~dp0"

set "JAR_PATH=..\..\program.jar"
set "INPUT_FILE=..\..\JuegosDePrueba\ClusteringBasico\JuegoD5_VectorizarCuestionarioConTiposMixtos.txt"
set "EXPECTED_FILE=..\..\JuegosDePrueba\ClusteringBasico\output_esperado_D5.txt"
set "TEMP_OUTPUT=resultado_actual.tmp"
set "MAIN_CLASS=edu.upc.prop.drivers.Driver"

echo -----------------------------------------------------
echo Ejecutando Test: Juego D5 (Vectorizar cuestionario con tipos mixtos)
