...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/ClusteringAvanzado/JuegoE3_AccuracyConKIncorrectoDebeFallar.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/ClusteringAvanzado/output_esperado_E3.txt"
...
echo "-----------------------------------------------------"
echo "Ejecutando Test: Juego E3 (Accuracy con K incierto que debe fallar)"
