...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/ImportarExportar/JuegoC2_ExportarEncuestaSinRespuestas.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/ImportarExportar/output_esperado_C2.txt"
