...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/FlujosIntegrados/JuegoG1_FlujoCompleto_CrearEditarAnadir_ClusteringExportarComparar.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/FlujosIntegrados/output_esperado_G1.txt"
...
echo "-----------------------------------------------------"
echo "Ejecutando Test: Juego G1 (Flujo completo: Crear, editar, anadir, clustering, exportar y comparar)"
