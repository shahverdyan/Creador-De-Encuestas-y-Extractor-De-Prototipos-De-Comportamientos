...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/ClusteringBasico/JuegoD5_VectorizarCuestionarioConTiposMixtos.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/ClusteringBasico/output_esperado_D5.txt"
