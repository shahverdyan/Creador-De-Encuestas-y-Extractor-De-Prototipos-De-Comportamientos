...
# Ruta al INPUT
INPUT_FILE="../../JuegosDePrueba/FlujosIntegrados/JuegoG2_FlujoImportar_AnadirRespuestas_DosAlgoritmos_Accuracy.txt"

# Ruta al OUTPUT ESPERADO
EXPECTED_FILE="../../JuegosDePrueba/FlujosIntegrados/output_esperado_G2.txt"
...
echo "-----------------------------------------------------"
echo "Ejecutando Test: Juego G2 (Flujo importar, anadir respuestas, dos algoritmos y accuracy)"
